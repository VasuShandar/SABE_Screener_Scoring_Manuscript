...
| Figure 2 (SABE vs HEI-2020 scatter) | SAS exports `scatter_data_1718.csv` (Figure 2 section); rendered by `figures_scatterplots.R` |
...
| Figure 4 (SABE vs AHEI-2010 scatter) | Same `scatter_data_1718.csv` (AHEI_TOTAL column); rendered by `figures_scatterplots.R` |
